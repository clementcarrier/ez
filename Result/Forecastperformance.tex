...
\hlstd{forecast2}\hlkwb{<-}\hlkwa{function}\hlstd{(}\hlkwc{data}\hlstd{,}\hlkwc{lag}\hlstd{,}\hlkwc{horizon}\hlstd{,}\hlkwc{preforecast}\hlstd{,}\hlkwc{adap}\hlstd{)\{}
  ...
  \hlstd{lv}\hlkwb{<-}\hlkwd{lassovar}\hlstd{(}\hlkwc{dat}\hlstd{=data,}\hlkwc{lags}\hlstd{=lag,}\hlkwc{adaptive}\hlstd{=adap)}
  ...
  \hlstd{\}} \hlkwa{else} \hlstd{\{}
    ...
    \hlstd{\}} \hlkwa{else} \hlstd{\{}
      ...
      \hlkwa{else} \hlstd{\{}
        ...
        \hlkwa{for} \hlstd{(i} \hlkwa{in} \hlstd{(preforecast}\hlopt{+}\hlnum{1}\hlstd{)}\hlopt{:}\hlstd{(horizon}\hlopt{+}\hlstd{preforecast))\{}
          \hlstd{fore[,i]}\hlkwb{<-}\hlstd{intercept}\hlopt{+}\hlstd{coeff1}\hlopt{%*%}\hlstd{fore[,i}\hlopt{-}\hlnum{1}\hlstd{]}\hlopt{+}\hlstd{coeff2}\hlopt{%*%}\hlstd{fore[,i}\hlopt{-}\hlnum{2}\hlstd{]}\hlopt{+}\hlstd{coeff3}\hlopt{%*%}\hlstd{fore[,i}\hlopt{-}\hlnum{3}\hlstd{]}\hlopt{+}\hlstd{coeff4}\hlopt{%*%}\hlstd{fore[,i}\hlopt{-}\hlnum{4}\hlstd{]}
        \hlstd{\}}
      \hlstd{\}}
    \hlstd{\}}
  \hlstd{\}}
